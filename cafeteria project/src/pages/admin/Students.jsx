          ...
          <div className="max-w-md w-full bg-surface-container-high rounded-2xl p-8 shadow-2xl border border-outline-variant/10 ambient-shadow">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="space-y-1 flex flex-col">
                ...
                <input type="password" required={modalMode === 'add'} value={currentStudent.password} onChange={e => setCurrentStudent({...currentStudent, password: e.target.value})} className="bg-surface-container-lowest border-none rounded-lg px-4 py-3 text-sm text-on-surface font-label focus:ring-2 focus:ring-primary/50 outline-none" placeholder="••••••••" />
              </div>
