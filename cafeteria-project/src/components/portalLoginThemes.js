...
export const PORTAL_THEMES = {
  customer: {
    ...
    proofLine: 'ordering daily at COMSATS campus',
    formEmoji: '👋',
    ...
    registerCopy: {
      ...
      proofLine: 'already ordering on COMSATS campus',
    },
  },
  cafe: {
    accent: '#ff6b35',
    ...
    proofLine: 'across COMSATS campus cafeterias',
    formEmoji: '☕',
  ...
  admin: {
    ...
    proofLine: 'for COMSATS Cafe administrators only',
    formEmoji: '⚙️',
