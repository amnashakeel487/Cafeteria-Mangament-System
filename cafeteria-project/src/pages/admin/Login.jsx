            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={isLoading}
                  placeholder="••••••••"
                  className="w-full bg-surface-container-lowest border border-outline-variant/15 focus:border-primary/60 rounded-lg pl-12 pr-12 py-3 text-sm focus:ring-1 focus:ring-primary/50 text-on-surface placeholder-on-surface-variant/30 transition-all font-label"
                  required
                />
                <button
                  type="button"
