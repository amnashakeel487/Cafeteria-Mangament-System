          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-[#1E1E2F] rounded-xl p-6 shadow-xl border border-[#594139]/20">
              ...
              <div className="space-y-4 mb-6">
                {activeOrder.items?.map((item) => (
                  <div key={item.id} className="flex justify-between items-start text-sm">
                    ...
                    <span className="font-mono text-[#e1bfb5]">{formatPrice(item.price)}</span>
                  </div>
                ))}
              </div>
              <div className="pt-4 border-t border-[#594139]/20 flex justify-between items-end">
                ...
                <span className="text-xl font-bold text-[#FFB59D]">{formatPrice(activeOrder.total_amount)}</span>
              </div>
            </div>
